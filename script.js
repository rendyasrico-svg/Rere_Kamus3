...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getRelevanceScore(item, query) {
        ...
        if (word === query || meaning === query) return 0;          // cocok persis
        if (word.startsWith(query) || meaning.startsWith(query)) return 1; // diawali kata yang dicari
        return 2; // cuma mengandung di tengah/akhir
    }
    ...
    function performSearch() {
        ...
        const results = dictionaryData
            ...
            .sort((a, b) => {
                ...
                // kalau skor sama, urutkan berdasar panjang kata (lebih pendek = lebih relevan)
